...
RSpec.describe "the equipments show page" do
    before(:each) do
        ...
        @equipment1 = Equipment.create!(brand: "Atomic Maven Skis", price: 299.97, in_stock: true)
        @equipment2 = Equipment.create!(brand: "Giro Ceva Helmet", price: 74.99, in_stock: false)
        @equipment3 = Equipment.create!(brand: "Smith Holt Helmet", price: 48.99, in_stock: true)
        @equipment4 = Equipment.create!(brand: "Black Crows Poles", price: 44.99, in_stock: false)
        @equipment5 = Equipment.create!(brand: "Volkl Poles", price: 49.0, in_stock: true)
    end
